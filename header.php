...
SUN - FRI (8:00 AM - 6:00PM)
</li>
<li>
<i class="fas fa-map-marker-alt"></i>
Office L214, US MALL, Kyanja Kampala
</li>
<li>
<i class="fas fa-mobile-alt"></i>
<a href="#">+256 75 76 45933</a>
</li>
</ul>
</div>
</div>
...
<div class="container">
  <nav class="navbar navbar-expand-lg my-navbar p-0">
     <a class="navbar-brand" href="index.php"><img src="img/log.png" class="img-fluid"/></a>
